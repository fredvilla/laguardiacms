        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input style="text-transform: capitalize;" type="text" name="fname"
                    value="<?= isset($_POST['fname']) ? $_POST['fname'] : $user->fname; ?>" class="form-control"
                    id="recipient-name">
                </div>
                <div class="form-group col-md-4">
                  <label>Middle Name:</label>
                  <input style="text-transform: capitalize;" type="text" name="mname"
                    value="<?= isset($_POST['mname']) ? $_POST['mname'] : $user->mname; ?>" class="form-control"
                    id="recipient-name">
                </div>
                <div class="form-group col-md-4">
                  <label>*Last Name:</label>
                  <input style="text-transform: capitalize;" type="text" name="lname"
                ...
                <div class="form-group col-md-4">
                  ...
                  <div class="d-flex">
                    <div class="input-group mb-2">
                      ...
                      <input maxlength="11" type="text" name="cn" value="<?= isset($_POST['cn']) ? $_POST['cn'] : $user->cn; ?>"
              ...
              <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  <label>*House #:</label>
                  <input maxlength="3" type="text" name="house_no" class="form-control" id="recipient-name"
            ...
            <div class="col-md-12">
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  <label style="margin-left: 67%;" class="col-form-label">Show Password <input type="checkbox" onclick="myFunction()"> </label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style="margin-left: 90%;" class="right">
